variable "server_name" {
  ...
  description = <<-EOT
    ...
    If both the server_name and server_id are empty, no server will be created or selected and data will be empty.
  EOT
  default     = ""
}
...
variable "image" {
  ...
  description = <<-EOT
    ...
    Please specify either image_id or image.
  EOT
  default     = ""
}
...
variable "image_id" {
  ...
  description = <<-EOT
    ...
    If you use this the image variable will be ignored.
    Please specify either image_id or image.
