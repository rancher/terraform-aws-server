...
* bump aws-actions/configure-aws-credentials from 6.2.0 to 6.2.1 ([#158](https://github.com/rancher/terraform-aws-server/issues/158)) ([7b4469d](https://github.com/rancher/terraform-aws-server/commit/7b4469db7f4b2dcc2fce11d308834d4b6eb1b233))
* bump aws-actions/configure-aws-credentials from 6.2.1 to 6.2.2 ([#160](https://github.com/rancher/terraform-aws-server/issues/160)) ([89af24a](https://github.com/rancher/terraform-aws-server/commit/89af24a17e4a6a2c8dfb4aecd873bdc7513c244d))
...
* bump fossas/fossa-action from 1.9.0 to 2.0.0 ([#159](https://github.com/rancher/terraform-aws-server/issues/159)) ([d6a4dfb](https://github.com/rancher/terraform-aws-server/commit/d6a4dfb81b0f0358130faf911a55116b0a678951))
...
* resolve broken dependabot config ([#156](https://github.com/rancher/terraform-aws-server/issues/156)) ([aafebfb](https://github.com/rancher/terraform-aws-server/commit/aafebfb60c308399501d0acd2e732bc2e43de3c0))
...
* update flake ([#161](https://github.com/rancher/terraform-aws-server/issues/161)) ([b226cca](https://github.com/rancher/terraform-aws-server/commit/b226cca75287457d7c2021abe70511dbdc342964))
...
* upgrade access module and add speed to test suite ([#155](https://github.com/rancher/terraform-aws-server/issues/155)) ([3f78661](https://github.com/rancher/terraform-aws-server/commit/3f78661da3859d6d741979a8c8dfa6fcfe1ade26))
...
* update supported images ([#101](https://github.com/rancher/terraform-aws-server/issues/101)) ([868847b](https://github.com/rancher/terraform-aws-server/commit/868847b39fab4ee1cc32b37e7d9e327c0e1e1275))


### Bug Fixes

* make sure test data directory exists ([#105](https://github.com/rancher/terraform-aws-server/issues/105)) ([f1e44ed](https://github.com/rancher/terraform-aws-server/commit/f1e44ed5e195598944cc4b78a8a54ee140dff782))
* remove left overs and redundant tests ([#104](https://github.com/rancher/terraform-aws-server/issues/104)) ([7a2b6cf](https://github.com/rancher/terraform-aws-server/commit/7a2b6cff87ab9dd112a529e15f56eea9e7cf7792))
* remove test data ([#103](https://github.com/rancher/terraform-aws-server/issues/103)) ([65b85fb](https://github.com/rancher/terraform-aws-server/commit/65b85fb9277a49e2b8eaa91ba1fb477eacb8c4a0))
...
* more version 6 fixes ([#91](https://github.com/rancher/terraform-aws-server/issues/91)) ([92d6746](https://github.com/rancher/terraform-aws-server/commit/92d6746cd37cc88691982f175d13e5b7b057f765))
